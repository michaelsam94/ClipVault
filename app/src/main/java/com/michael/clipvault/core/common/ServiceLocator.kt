package com.michael.clipvault.core.common

import android.content.Context
import com.michael.clipvault.core.database.*
...
object ServiceLocator {
    ...
    fun setRepositoriesForTesting(
        historyRepo: ClipboardHistoryRepository,
